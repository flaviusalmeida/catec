...
function contextoHistoricoEntidade(item: PainelHistoricoItem): string | null {
...
export function metaHistoricoItem(item: PainelHistoricoItem): string {
...
export function textoHistoricoItem(item: PainelHistoricoItem): string | null {
