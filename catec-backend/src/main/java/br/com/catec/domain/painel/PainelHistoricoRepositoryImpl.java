...
@Repository
class PainelHistoricoRepositoryImpl implements PainelHistoricoRepository {
    ...
    public List<PainelHistoricoLinha> listarHistoricoProjeto(
        ...
        List<PainelHistoricoLinha> out = new ArrayList<>(rows.size());
        for (Object[] r : rows) {
            out.add(mapRow(r));
        }
        return out;
    ...
    private static PainelHistoricoLinha mapRow(Object[] r) {
        return new PainelHistoricoLinha(
                (String) r[1],
