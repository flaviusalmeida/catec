...
public class ProjetoHistoricoService {
    ...
    public PageResponse<ProjetoHistoricoItemResponse> historico(
        ...
        long total = projetoHistoricoRepository.contarHistoricoProjeto(projetoId, propostaIds);
        List<ProjetoHistoricoLinha> linhas =
                projetoHistoricoRepository.listarHistoricoProjeto(projetoId, propostaIds, offset, safeSize);
